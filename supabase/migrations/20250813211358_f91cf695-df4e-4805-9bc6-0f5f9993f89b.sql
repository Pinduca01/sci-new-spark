-- Remover a coluna data_curso_cve que está causando problemas
ALTER TABLE bombeiros DROP COLUMN IF EXISTS data_curso_cve;

-- Adicionar novamente a coluna data_curso_cve corretamente
ALTER TABLE bombeiros ADD COLUMN data_curso_cve date;

-- Inserir os dados reais dos bombeiros
