...
export function ExportarPDFViaturasSection() {
  ...
  const transformarChecklistParaPDF = (checklistRaw: any, viaturaPlaca: string): ChecklistDetalhado => {
    return {
      id: checklistRaw.id,
      tipo: 'viatura',
      tipo_detalhe: checklistRaw.tipo_checklist || 'BA-2',
  ...
  const handleGerarPDFMensal = async () => {
    ...
    try {
      ...
      // Gerar PDF com dados transformados
      generateChecklistMensalFormatoOficialPDF(viaturaPlaca, mes, ano, checklistsTransformados);
